...
if (!fs.existsSync(SRC_PLIST)) {
  console.error(
    `ERROR: ${SRC_PLIST} not found. Place GoogleService-Info.plist in the project root.`,
  )
  process.exit(1)
}
...
const relativePlistPath = path.relative(
  path.join(IOS_DIR, `${projectName}.xcodeproj`, ".."),
  destPlistPath,
)
